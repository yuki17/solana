        ...
        <div className="fusion">
          ...
          <div className="mid_box">
            ...
            <div className="add_action">
              ...
              <div> <img src={ProduceInfo} alt="" /><div> 0.00 <span>SOL</span></div></div>
              <div>Two gemstone of the same level can be upgraded to a gemstone with more stars. There is a certain risk of failure。</div>
              <div>Upgrade</div>
            </div>
          </div>
